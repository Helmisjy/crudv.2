...
<?php $this->Section('content') ?>
            ...
            <!-- <div class="form-group">
                ...
                <input type="text" class="form-control" id="sampul" name="sampul" onchange="previewImg()" placeholder="img" value="<?= $equipment['sampul']; ?>">
            </div> -->
            <div class="mt-2">
                <p>Change Image</p>
            </div>
            <div class="custom-file mb-3">
                    <input type="file" class="custom-file-input" id="sampul" name="sampul" onchange="previewImg()" value="<?= $equipment['sampul']; ?>"> 
                    <label class="custom-file-label" for="sampul"><?= $equipment['sampul']; ?></label>
            </div>
            <div class="col-md-6 mb-3">
                    <img src="/img/<?= $equipment['sampul']; ?>" class="img-fluid img-thumbnail img-preview" alt="" value="<?= $equipment['sampul']; ?>">
            </div>
            <div class="form-group">
