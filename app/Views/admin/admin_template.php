...
<head>
    ...
    <title>BAP Admin - Dashboard</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/admin">
                ...
                <!-- <div class=" d-none d-lg-inline small ">   -->
                    <!-- <img class="img-fluid" src="img/BAP Logo.png" alt=""> -->
                    <!-- <i class="fas fa-laugh-wink"></i> -->
                    <img class="img-fluid" src="img/BAP Logo Pendek.png" alt="" style="height: 50px;">
                </div>
                <!-- <div class="sidebar-brand-text mx-2">BAP Admin</div> -->
            </a>
            ...
            <!-- Nav Item - Tables Cutomer-->
            <li class="nav-item">
                <a class="nav-link" href="/customer">
                    <i class="fas fa-fw fa-envelope"></i>
                    <span>Email Customers</span></a>
            </li>
            ...
            <li class="nav-item">
                ...
                <span>Web Content</span></a>
            </li>



            <li class="nav-item">
                <a class="nav-link" href="admin/recuitment">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; PT.Berlian Amal Perkasa</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script>
        ...
        function previewPdf(){
            ...
            pdfLabel.textContent = pdf.files[0].name;
