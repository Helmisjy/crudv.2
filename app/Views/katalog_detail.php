            ...
            <div class="card-body mb-5 p-3" style="max-width: 1200px;">
                <div class="row g-4">
                    ...
                    <div class="col-md-5  mx-5">
                        <div class="card-body">
                            <h1 class="card-title mb-4"><?= $equipment['nama_alat']; ?></h1>
                            <p class="card-text mb-1"><b>Brand :</b> <?= $equipment['brand']; ?></p>
                            <p class="card-text mb-1"><b>Capacity :</b> <?= $equipment['capacity']; ?></p>
                            <p class="card-text mb-3"><b>PDF File :</b> <?= $equipment['pdf']; ?></p>
                            <!-- <p class="card-text"><small class="text-muted"><?= $equipment['created_at']; ?></small></p> -->
                            <div class="my-3">
                                <a href="" class="btn btn-warning mr-2">Download PDF</a>
                            </div>
                           <div class="social">
                            <p class="mb-1">Share :</p>
                                <a href="#" class="mx-1 btn btn-secondary text white bi bi-facebook rounded-circle"></a>
                                <a href="#" class="mx-1 btn btn-info text-white bi bi-twitter rounded-circle"></a>
                                <a href="#" class="mx-1 btn btn-success text-white bi bi-whatsapp rounded-circle"></a>
                            </div>
                        </div>
                    </div>
                </div>
