...
<?= $this->section('content'); ?>
    ...
    <!-- News Start -->
    <div class="container-xxl" style="border-radius: 30px;">
        <div class="container align-items-center">
            <?php foreach($news as $n) : ?>
            <div class="shadow card-body mb-5 align-items-center">
                <div class="row g-2"> 
                    ...
                    <div class="col-md-9 bg-white">
                        <div class="card-body mb-1">
                            <h3 class="card-title p-0 text-primary"><a href="/news/<?= $n['id']; ?>"><?= $n['judul']; ?></a></h3>
                            <hr class="col-lg-12">
                        ...
                        <div class="col-md-10 mx-1 mb-1 d-flex justify-content-end">
                        <!-- <a href="/news/<?= $n['id']; ?>" class="btn btn-primary text-white">Detail</a> -->
                        </div>
                    </div>
                </div>
            </div>
